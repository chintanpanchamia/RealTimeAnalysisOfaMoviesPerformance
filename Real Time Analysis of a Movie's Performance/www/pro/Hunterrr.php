    ...
    <hr class="featurette-divider">
      ...
      <div class="row featurette">
        <div class="col-md-7 col-md-push-5">
          ...
          <p class="lead">Actors: <?php echo $actors_array[0].",".$actors_array[1].",".$actors_array[2].",".$actors_array[3]; ?><br/>
          Director: <?php echo $actors_array[4]; ?> <br/> Producer: <?php echo $actors_array[5]; ?> <br/> Music Composer: <?php echo $actors_array[6]; ?>
          <br/> Description: <?php echo $description; ?></p>
        </div>
